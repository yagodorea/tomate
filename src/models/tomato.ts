...
export class PomodoroTomato {
    ...
    public async load(): Promise<void> {
        ...
        // Load bottom half
        const bottomGeometry = await loader.loadAsync('/src/assets/pomodoro_bottom_v01.stl');
        ...
        // Load top half
        const topGeometry = await loader.loadAsync('/src/assets/pomodoro_top_v01.stl');
